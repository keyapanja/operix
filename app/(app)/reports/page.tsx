...
export default async function ReportsOverviewPage() {
  ...
  const [
    ...
    prisma.task.count({ where: { deletedAt: null, project: { companyId }, status: { not: "COMPLETED" } } }),
    prisma.task.count({ where: { deletedAt: null, project: { companyId }, status: "COMPLETED", completedAt: dtWin } }),
    ...
    prisma.task.groupBy({ by: ["status"], where: { deletedAt: null, project: { companyId } }, _count: { _all: true } }),
